...
| File                                                    | Description                                        |
| ------------------------------------------------------- | -------------------------------------------------- |
| `RimWorld-Mod-Downloader-{{RELEASE_VERSION}}-setup.exe` | Windows NSIS installer, recommended for most users |
| `RimWorld-Mod-Downloader-{{RELEASE_VERSION}}.msi`       | Windows MSI installer for standardized deployment  |
